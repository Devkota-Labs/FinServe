...
{
    // Register
    Task<Result> RegisterAsync(RegisterRequestDto dto, CancellationToken cancellationToken);
    ...
    Task<Result> SendApprovalFollowUpMailAsync(int userId, CancellationToken cancellationToken);
}
